...
The script used to convert [Praat](https://www.fon.hum.uva.nl/praat/) tool transcribe files into pandas DataFrame. It takes the transcribed files and process every line. 
Finally, it generates dataframe in following format `start,end,user`.
...
for line in lines:
    ...
    if read_flag:
        ...
        # When all three lines are read.
            ...
            df = df.append({'start': start, 'end': end,
